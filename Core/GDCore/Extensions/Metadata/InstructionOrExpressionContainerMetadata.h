...
class GD_CORE_API InstructionOrExpressionContainerMetadata {
 public:
   ...
   * the condition.
   */
  virtual gd::InstructionMetadata& AddCondition(const gd::String& name_,
   ...
   * the action.
   */
  virtual gd::InstructionMetadata& AddAction(const gd::String& name_,
                                     const gd::String& fullname_,
                                     const gd::String& description_,
                                     const gd::String& sentence_,
                                     const gd::String& group_,
   ...
   * Declare a new condition as being part of the behavior.
   */
  virtual gd::InstructionMetadata& AddScopedCondition(const gd::String& name_,
                                              const gd::String& fullname_,
                                              const gd::String& description_,
                                              const gd::String& sentence_,
                                              const gd::String& group_,
   ...
   * Declare a new action as being part of the behavior.
   */
  virtual gd::InstructionMetadata& AddScopedAction(const gd::String& name_,
                                           const gd::String& fullname_,
                                           const gd::String& description_,
                                           const gd::String& sentence_,
                                           const gd::String& group_,
   ...
   */
  virtual gd::ExpressionMetadata& AddExpression(const gd::String& name_,
                                        const gd::String& fullname_,
                                        const gd::String& description_,
                                        const gd::String& group_,
                                        const gd::String& smallicon_) = 0;
   ...
   */
  virtual gd::ExpressionMetadata& AddStrExpression(const gd::String& name_,
                                           const gd::String& fullname_,
                                           const gd::String& description_,
                                           const gd::String& group_,
                                           const gd::String& smallicon_) = 0;
   ...
   * one.
   */
  virtual gd::InstructionMetadata& AddDuplicatedAction(
      const gd::String& newActionName, const gd::String& copiedActionName) = 0;
   ...
   * one.
   */
  virtual gd::InstructionMetadata& AddDuplicatedCondition(
