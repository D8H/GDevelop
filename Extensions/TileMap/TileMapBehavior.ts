...
namespace gdjs {
  ...
  export class TileMapBehavior extends gdjs.RuntimeBehavior implements TileMap {
    ...
    setTileAtGridCoordinates(
      ...
      this.object.setTileAtGridCoordinates(
      tileId,
      columnIndex,
      rowIndex);
    }
    ...
    flipTileOnYAtGridCoordinates(
      ...
      this.object.flipTileOnYAtGridCoordinates(
      columnIndex,
      rowIndex,
      flip);
    }
    ...
    flipTileOnXAtGridCoordinates(
      ...
      this.object.flipTileOnXAtGridCoordinates(
      columnIndex,
      rowIndex,
      flip);
    }
    ...
    isTileFlippedOnXAtGridCoordinates(
      ...
      return this.object.isTileFlippedOnXAtGridCoordinates(columnIndex, rowIndex);
    }
    ...
    isTileFlippedOnYAtGridCoordinates(
      ...
      return this.object.isTileFlippedOnYAtGridCoordinates(columnIndex, rowIndex);
    }
