    ...
    return (
      ...
      >
        {mapFor(0, formattedTexts.size(), i => {
          ...
          const expressionNode = instruction.getParameter(parameterIndex).getRootNode(parameterType, parser).get();
          const expressionValidator = new gd.ExpressionValidator();
          expressionNode.visit(expressionValidator);
          const expressionIsValid = expressionValidator.getErrors().size() === 0;
